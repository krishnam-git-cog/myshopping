...
let covFlag=true;
if(test=='ui'){
  testEndsWith = 'test_ui.js';
  covFlag = false;
}
process.env.reportServerUrl = argv.reportServerUrl;
...
module.exports = {
  ...
  // A path to a module which exports an async function that is triggered once before all test suites
   globalSetup: "./test/preExecutionSetup.js",

  // A path to a module which exports an async function that is triggered once after all test suites
   globalTeardown: "./test/postExecutionTeardown.js",
